...
ARCHETYPES: dict[str, dict[str, str]] = {
    ...
    "1970s Leisure Lounge": {
        ...
        "outfit_description": "an open-collar wide-lapel patterned shirt unbuttoned at the chest, a fitted earth-tone leisure suit jacket, flared trousers, and stacked-heel boots",
        "expression": "confident", "location": "dimly lit cocktail lounge",
        "lighting": "warm string lights bokeh background", "shot_type": "medium shot from waist up",
        "mood": "confident",
    },
    ...
    "Game-Day Fan (Female)": {
        "gender": "Female", "ethnicity": "Nigerian", "body_type": "fit", "height": "average height",
        ...
        "accessories": "no accessories",
        "outfit_description": "a team jersey knotted and cropped over a fitted tank top, high-waisted denim shorts, knee-high socks, and chunky sneakers, with two bold stripes of team-colour paint across each cheek",
        "expression": "bright smile", "location": "high school gymnasium",
    ...
    "Game-Day Fan (Male)": {
        ...
        "outfit_description": "a team jersey over a long-sleeve tee, athletic shorts, and sneakers, a backwards baseball cap, and two stripes of team-colour paint across each cheek",
    ...
    "Kawaii Street Fashion (Female)": {
        "gender": "Female", "ethnicity": "Japanese", "body_type": "petite and slim", "height": "petite",
    ...
    "Kawaii Street Fashion (Male)": {
        "gender": "Male", "ethnicity": "Japanese", "body_type": "slim", "height": "slightly below average height",
    ...
    "Classic Hollywood Starlet": {
        ...
        "outfit_description": "a floor-length bias-cut satin gown with a plunging back and elbow-length silk gloves",
        "expression": "sultry", "location": "art gallery opening night",
        "lighting": "dramatic single overhead spotlight", "shot_type": "medium shot from waist up", "mood": "confident",
    },
    "Classic Hollywood Leading Man": {
        ...
        "outfit_description": "a sharply tailored black tuxedo with satin lapels, a crisp white dress shirt, a black bow tie, and a white pocket square",
        "expression": "confident", "location": "art gallery opening night",
        "lighting": "dramatic chiaroscuro side lighting", "shot_type": "medium shot from waist up", "mood": "confident",
    },
    "Backyard Country Casual (Female)": {
        "gender": "Female", "ethnicity": "English", "body_type": "curvy", "height": "average height",
        ...
        "outfit_description": "a fitted ribbed tank top tied at the midriff, cut-off high-waisted denim shorts, and worn flip-flops",
    ...
    "Backyard Country Casual (Male)": {
        "gender": "Male", "ethnicity": "English", "body_type": "stocky", "height": "average height",
    ...
    "1950s Homemaker": {
        ...
        "outfit_description": "an immaculate belted shirtwaist dress with a full swing skirt and a frilled apron, and low kitten heels",
    ...
    "1980s Aerobics (Female)": {
        "gender": "Female", "ethnicity": "English", "body_type": "toned", "height": "average height",
    ...
    "1980s Aerobics (Male)": {
        ...
        "accessories": "no accessories",
        "outfit_description": "a tight sleeveless tank top, brightly striped spandex shorts over footless tights, slouchy legwarmers, and white high-top sneakers",
        "expression": "confident", "location": "local gym weight room",
        "lighting": "high key bright even lighting", "shot_type": "medium shot from waist up", "mood": "playful",
    },
    "Martial Artist": {
    ...
    "Y2K Mall Casual (Female)": {
        ...
        "outfit_style": "casual", "accessories": "no accessories",
        "outfit_description": "a fitted baby tee over low-rise flared jeans with a wide studded belt, a cropped denim jacket, and platform flip-flops",
        "expression": "playful", "location": "movie theater lobby", "lighting": "cool LED overhead lighting",
        "shot_type": "full body shot", "mood": "cheerful",
    },
    "Y2K Mall Casual (Male)": {
        "gender": "Male", "ethnicity": "English", "body_type": "lean", "height": "tall",
        ...
        "accessories": "no accessories",
        "outfit_description": "an oversized graphic tee under an open flannel shirt, baggy low-slung jeans, a puka-shell necklace, and chunky skate sneakers",
